# Operator Quickstart — Wired Telecommunications Network Operations

Shortest path from clone to a verified local dry-run for **ISIC 6110** (`cloud-itonami-isic-6110`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6110.git
cd cloud-itonami-isic-6110
```
...
- Blueprint governor key: `network-provisioning-governor`
- Likely source path: `netops.governor.cljc`
